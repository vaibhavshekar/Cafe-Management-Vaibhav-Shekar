...
def Stats():
    ...
    txtmgm = Text(r,font=('arial',11,'bold'),bd=8,width=50,height=10,bg="white")
...
btnExit=Button(fb2,padx=16,pady=1,bd=4,fg="black",font=('arial',16,'bold'),width=5,text="MgMnt",command=Stats).grid(row=0,column=3)
